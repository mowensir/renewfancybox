...
```
php composer.phar require --prefer-dist renewfancybox/yii2-fancybox "dev-master"
```

or add

```
"renewfancybox/yii2-fancybox": "dev-master"
```
...
```php
<?php
echo renewfancybox\fancybox\FancyBox::widget([
